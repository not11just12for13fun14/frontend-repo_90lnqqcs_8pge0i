...
const logos = [
  ...
  { name: 'Crypto', color: '#eab308' },
]

export default function Payments() {
  return (
    <section className="relative bg-[#050505] py-16 sm:py-20 md:py-24">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_rgba(16,185,129,0.15),transparent_60%)]" />
      <div className="relative mx-auto max-w-7xl px-6">
        <motion.h3
          ...
          className="text-center text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-emerald-300 to-amber-300"
        >
        ...
        <div className="mt-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 sm:gap-6">
          {logos.map((l, i) => (
            <motion.div
              ...
              className="relative rounded-2xl border border-cyan-400/30 bg-gradient-to-b from-[#0a0a0a] to-[#0c0c0c] p-6 text-center shadow-[0_0_20px_rgba(34,211,238,0.35)]"
            >
